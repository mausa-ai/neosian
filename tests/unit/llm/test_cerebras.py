...
class TestCerebrasClientReasoningEffort:
    ...
    async def test_reasoning_effort_raises_for_non_reasoning_model(self) -> None:
        ...
        assert "fake-small" in str(exc_info.value)
...
@pytest.mark.unit
class TestCerebrasClientCaching:
    """Test prompt caching token extraction."""
...
@pytest.mark.unit
class TestCerebrasNestedSchema:
    """Cerebras strict mode requires additionalProperties on every object."""
